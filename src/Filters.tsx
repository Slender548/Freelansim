...
import MultiSelect, {Item} from './Components/Habr/Desktop/MultiSelect';
...
const items: Item[] = [
  {
    ...
    active: false,
    items: [
      {name: 'Nissan Sunny', active: false, id: 100},
      {name: 'Toyota Corolla', active: false, id: 101},
      {name: 'Honda Civic', active: false, id: 102},
    ],
  },
  {
    name: 'Vans',
    ...
    active: false,
    items: [
      {name: 'Ford Transit', active: false, id: 200},
      {name: 'Toyota Sienna', active: false, id: 201},
    ],
  },
  {
    name: 'SUVs',
    ...
    active: false,
    items: [
      {name: 'Toyota RAV4', active: false, id: 300},
      {name: 'Ford Explorer', active: false, id: 301},
    ],
  },
  {
    name: 'Motorbikes',
    ...
    active: false,
    items: [
      {name: 'Kawasaki KX', active: false, id: 400},
      {name: 'Ducati Panigale', active: false, id: 401},
      {name: 'BMW Roadster', active: false, id: 402},
    ],
  },
];
